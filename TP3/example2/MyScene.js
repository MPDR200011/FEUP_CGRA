...
class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        let woodColor = this.hexToRgbA('#553f31');
        let woodDifuse = 1;
        let woodSpecular = 0.1;
        this.material4 = new CGFappearance(this);
        this.material4.setAmbient(0,0,0,1.0);
        this.material4.setDiffuse(woodColor[0]*woodDifuse,woodColor[1]*woodDifuse,woodColor[2]*woodDifuse,1.0);
        this.material4.setSpecular(woodColor[0]*woodSpecular,woodColor[1]*woodSpecular,woodColor[2]*woodSpecular,1.0);
